...
// TODO: this should really be generated by a nice derive macro
impl QueryResponses for QueryMsg {
    fn query_responses() -> BTreeMap<&'static str, RootSchema> {
        [
            ("verifier", schema_for!(VerifierResponse)),
            ("other_balance", schema_for!(AllBalanceResponse)),
            ("recurse", schema_for!(RecurseResponse)),
            ("get_int", schema_for!(IntResponse)),
        ]
        .into_iter()
        .collect()
    }
