...
mod wasm {
    ...
    pub extern "C" fn init(params_ptr: *mut c_void, msg_ptr: *mut c_void) -> *mut c_void {
        exports::do_init(
            &contract::init::<imports::ExternalStorage, imports::ExternalAddresser>,
            params_ptr,
            msg_ptr,
        )
    }
    ...
    pub extern "C" fn handle(params_ptr: *mut c_void, msg_ptr: *mut c_void) -> *mut c_void {
        exports::do_handle(
            &contract::handle::<imports::ExternalStorage, imports::ExternalAddresser>,
            params_ptr,
            msg_ptr,
        )
    }
    ...
    pub extern "C" fn query(msg_ptr: *mut c_void) -> *mut c_void {
        exports::do_query(&contract::query::<imports::ExternalStorage, imports::ExternalAddresser>, msg_ptr)
    }
}
