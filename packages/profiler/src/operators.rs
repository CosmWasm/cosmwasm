...
impl From<&Operator<'_>> for OperatorSymbol {
    fn from(op: &Operator<'_>) -> Self {
        match op {
            ...
            Operator::I32x4RelaxedTruncSatF64x2SZero => OperatorSymbol::I32x4RelaxedTruncSatF64x2SZero,
            Operator::I32x4RelaxedTruncSatF64x2UZero => OperatorSymbol::I32x4RelaxedTruncSatF64x2UZero,
