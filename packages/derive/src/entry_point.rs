...
fn expand_attributes(func: &mut syn::ItemFn) -> syn::Result<TokenStream> {
...
pub fn entry_point_impl(attr: TokenStream, item: TokenStream) -> TokenStream {
