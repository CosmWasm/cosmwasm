...
use crate::serde::{from_json_slice, to_json_binary};
...
impl<C: CustomQuery + DeserializeOwned> Querier for MockQuerier<C> {
    fn raw_query(&self, bin_request: &[u8]) -> QuerierResult {
        let request: QueryRequest<C> = match from_json_slice(bin_request) {
            Ok(v) => v,
            Err(e) => {
...
mod tests {
    ...
    #[cfg(feature = "cosmwasm_1_3")]
    use crate::DenomUnit;
    use crate::{coin, coins, from_json_binary, to_json_binary, ContractInfoResponse, Response};
    #[cfg(feature = "staking")]
    ...
    fn bank_querier_supply() {
        ...
        let elf = bank
            ...
            .unwrap()
            .unwrap();
        let res: SupplyResponse = from_json_binary(&elf).unwrap();
        ...
        let fly = bank
            ...
            .unwrap()
            .unwrap();
        let res: SupplyResponse = from_json_binary(&fly).unwrap();
        ...
        let atom = bank
            ...
            .unwrap()
            .unwrap();
        let res: SupplyResponse = from_json_binary(&atom).unwrap();
    ...
    fn bank_querier_metadata_works() {
        ...
        let res = bank
            ...
            .unwrap()
            .unwrap();
        let res: AllDenomMetadataResponse = from_json_binary(&res).unwrap();
        ...
        let more_res = bank
            ...
            .unwrap()
            .unwrap();
        let more_res: AllDenomMetadataResponse = from_json_binary(&more_res).unwrap();
        assert_eq!(
    ...
    fn distribution_querier_delegation_rewards() {
        ...
        let res = distribution.query(&query).unwrap().unwrap();
        let res: DelegationRewardsResponse = from_json_binary(&res).unwrap();
    ...
    fn ibc_querier_channel_existing() {
        ...
        let chan: ChannelResponse = from_json_binary(&raw).unwrap();
    ...
    fn ibc_querier_channels_matching() {
        ...
        let raw = ibc.query(query).unwrap().unwrap();
        let res: ListChannelsResponse = from_json_binary(&raw).unwrap();
    ...
    fn ibc_querier_port() {
        ...
        let raw = ibc.query(query).unwrap().unwrap();
        let res: PortIdResponse = from_json_binary(&raw).unwrap();
    ...
    fn staking_querier_all_validators() {
        ...
        let raw = staking
            ...
            .unwrap()
            .unwrap();
        let vals: AllValidatorsResponse = from_json_binary(&raw).unwrap();
    ...
    fn staking_querier_validator() {
        ...
        let raw = staking
            ...
            .unwrap()
            .unwrap();
        let res: ValidatorResponse = from_json_binary(&raw).unwrap();
    ...
    fn get_all_delegators(
        ...
        let raw = staking
            ...
            .unwrap()
            .unwrap();
        let dels: AllDelegationsResponse = from_json_binary(&raw).unwrap();
        dels.delegations
    }
    ...
    fn get_delegator(
        ...
        let raw = staking
            ...
            .unwrap()
            .unwrap();
        let dels: DelegationResponse = from_json_binary(&raw).unwrap();
        dels.delegation
    }
            ...
            match request {
                ...
                WasmQuery::Smart { contract_addr, msg } => {
                    if *contract_addr == constract1 {
                        #[derive(Deserialize)]
                        struct MyMsg {}
                        let _msg: MyMsg = match from_json_binary(msg) {
                            Ok(msg) => msg,
                            Err(err) => {
