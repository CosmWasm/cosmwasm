...
mod tests {
    ...
    fn decimal_deserialize() {
        assert_eq!(
            from_json_slice::<Decimal>(br#""0""#).unwrap(),
            Decimal::zero()
        );
        assert_eq!(
            from_json_slice::<Decimal>(br#""1""#).unwrap(),
            Decimal::one()
        );
        assert_eq!(
            from_json_slice::<Decimal>(br#""000""#).unwrap(),
            Decimal::zero()
        );
        assert_eq!(
            from_json_slice::<Decimal>(br#""001""#).unwrap(),
            Decimal::one()
        );

        assert_eq!(
            from_json_slice::<Decimal>(br#""0.08""#).unwrap(),
            Decimal::percent(8)
        );
        assert_eq!(
            from_json_slice::<Decimal>(br#""0.87""#).unwrap(),
            Decimal::percent(87)
        );
        assert_eq!(
            from_json_slice::<Decimal>(br#""8.76""#).unwrap(),
            Decimal::percent(876)
        );
        assert_eq!(
            from_json_slice::<Decimal>(br#""87.65""#).unwrap(),
